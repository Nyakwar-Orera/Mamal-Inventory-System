...
def index():
    ...
    return render_template('auth/index.html')  # Shows the landing HTML page

# Optional: Keep this if you still want the original message accessible
@bp.route('/info')
def info():
...
# QR code scan route remains unchanged
