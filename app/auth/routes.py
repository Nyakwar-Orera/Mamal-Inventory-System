...
# 🚫 REMOVE this route completely (handled in main.routes.py)
# @bp.route('/')
# def index():
...
def logout():
    ...
    return redirect(url_for('main.index'))  # Redirects to new landing page in main.routes
...
def reset_password(token):
    ...
    if not user:
        ...
        return redirect(url_for('main.index'))  # Points to new landing page
